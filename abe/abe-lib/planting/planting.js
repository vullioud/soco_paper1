 ...
 */
 lib.planting.general = function(options) {
    ...
    const opts = lib.mergeOptionsSafe(defaultOptions, options || {});
...
lib.planting.speciesDefaults = {
    ...
    'pisy': { species: 'pisy', h: 0.3, age: 1, pattern: 'circle10', random: true,
        n: function(proportion) {return proportion*10000/272; /* 272: area circle10 */} },
    // jonas: just copied the standard values to avoid error
    // add lines for poni,acpl,pini,ulgl,potr,soar,pice,acca,alin,pimu,qupu, coav
    'algl': { species: 'pisy', h: 0.3, age: 1, pattern: 'circle10', random: true,
        n: function(proportion) {return proportion*10000/272; /* 272: area circle10 */} },
    'poni': { species: 'poni', h: 0.3, age: 1, pattern: 'circle10', random: true,
        n: function(proportion) {return proportion*10000/272; /* 272: area circle10 */} },
    'acpl': { species: 'acpl', h: 0.3, age: 1, pattern: 'circle10', random: true,
        n: function(proportion) {return proportion*10000/272; /* 272: area circle10 */} },
    'pini': { species: 'pini', h: 0.3, age: 1, pattern: 'circle10', random: true,
        n: function(proportion) {return proportion*10000/272; /* 272: area circle10 */} },
    'ulgl': { species: 'ulgl', h: 0.3, age: 1, pattern: 'circle10', random: true,
        n: function(proportion) {return proportion*10000/272; /* 272: area circle10 */} },
    'potr': { species: 'potr', h: 0.3, age: 1, pattern: 'circle10', random: true,
        n: function(proportion) {return proportion*10000/272; /* 272: area circle10 */} },
    'soar': { species: 'soar', h: 0.3, age: 1, pattern: 'circle10', random: true,
        n: function(proportion) {return proportion*10000/272; /* 272: area circle10 */} },
    'pice': { species: 'pice', h: 0.3, age: 1, pattern: 'circle10', random: true,
        n: function(proportion) {return proportion*10000/272; /* 272: area circle10 */} },
    'acca': { species: 'acca', h: 0.3, age: 1, pattern: 'circle10', random: true,
        n: function(proportion) {return proportion*10000/272; /* 272: area circle10 */} },
    'alin': { species: 'alin', h: 0.3, age: 1, pattern: 'circle10', random: true,
        n: function(proportion) {return proportion*10000/272; /* 272: area circle10 */} },
    'pimu': { species: 'pimu', h: 0.3, age: 1, pattern: 'circle10', random: true,
        n: function(proportion) {return proportion*10000/272; /* 272: area circle10 */} },
    'qupu': { species: 'qupu', h: 0.3, age: 1, pattern: 'circle10', random: true,
        n: function(proportion) {return proportion*10000/272; /* 272: area circle10 */} },
    'coav': { species: 'coav', h: 0.3, age: 1, pattern: 'circle10', random: true,
        n: function(proportion) {return proportion*10000/272; /* 272: area circle10 */} }
